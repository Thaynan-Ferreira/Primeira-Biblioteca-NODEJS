...
async function criaESalvaArquivo(listaPalavras, caminhoArquivo) {
    ...
    const textoPalavras = JSON.stringify(listaPalavras, null, 2); //converte a lista de palavras para uma string formatada em JSON, usando a função JSON.stringify, passando a lista de palavras, o replacer (null) e o space (2) para formatar a string com indentação de 2 espaços
    try {
